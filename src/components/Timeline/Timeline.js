            ...
            <ol class="items-start sm:flex bg-zinc-900 rounded-lg py-6 card p-12">
                ...
                <li class="relative mb-6 sm:mb-0">
                    ...
                    <div class="mt-3 sm:pr-8">
                        ...
                        <p class="text-base font-normal text-gray-500 dark:text-gray-400 max-w-md">
                ...
                <li class="relative mb-6 sm:mb-0">
                    ...
                    <div class="mt-3 sm:pr-8">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white items-center flex">
                            Deloitte Digital
                            <span class="animate-pulse bg-blue-100 text-blue-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300 ml-3">
                                Latest
                            </span>
                        </h3>
                        <time class="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">
